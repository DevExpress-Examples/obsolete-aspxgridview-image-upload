<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Grid_Editing_ImageUpload_ImageUpload" %>
...
<body>
	<form id="form1" runat="server" enctype="multipart/form-data">
		...
		<dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False"
			DataSourceID="ObjectDataSource1" KeyFieldName="ID" Width="369px" OnRowInserting="ASPxGridView1_RowInserting">
			<Columns>
